...
const CommentItem = memo(({ comment, formatDate, index }) => (
  <div
...
const CommentSection = () => {
  ...
  return (
    <div
      className="w-full bg-gradient-to-br from-white/10 via-white/5 to-transparent rounded-2xl overflow-hidden backdrop-blur-xl shadow-2xl border border-white/10"
      data-aos="fade-up"
      data-aos-duration="1000"
    >
      <div
